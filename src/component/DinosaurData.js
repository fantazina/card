...
import parki from './img/파키리노사우루스.png';
import albert from './img/알베르토사우루스.png';
import styraco from './img/스티라코사우루스.png';
...
export default [
    ...
    {
        name : '기가노토사우루스',
        content : '기가노토사우루스는 전기 백악기(1억 년 전 ~ 9700만 년 전)에 살았으며 남아메리카의 아르헨티나지역에서 발견된 육식공룡입니다. 수각류인 기가노토사우루스는 ‘거대한 남쪽 도마뱀’이란 의미를 가지고 있습니다. 거대한 용각류 공룡들보다는 작았지만 힘과 빠른 속도로 커다란 공룡들을 사냥하곤 했습니다. 티라노사우루스가 먹잇감을 무는 힘의 1/3에 불과했었기 때문에 주로 살점을 베어 내는 형태의 공격으로 사냥했었을 것으로 추정합니다.',
        photo : 'https://i.namu.wiki/i/bB1Pnn9kWYwWqDGZ6JkT_WxVKNVqQ3Tq_Mw-GBcJMyGitRoXqhQ6YRSROUYvwITE_EirBdQwTsjtZS4U0tE4Rw.webp'
    },
    {
        name : '파키리노사우루스',
        content : '파키리노사우루스는 후기 백악기(1억 년 전 ~ 6600만 년 전)에 살았으며 미국 알래스카주, 캐나다에서 발견된 초식공룡입니다. 다른 각룡류와 다르게 뾰족한 뿔이 없이 울퉁불퉁한 혹이 있으며 다른 부분은 각룡류 특징과 비슷합니다. 코 위와 눈 위에 울퉁불퉁한 혹 때문에 ‘두꺼운 코 도마뱀’이란 파키리노사우루스 이름을 가지게 되었으며 아마도 위험에 처하면 혹으로 박치기를 했을 것으로 추측합니다.',
        photo : parki
    },
    {
        name : '스티라코사우루스',
        content : '스티라코사우루스는 후기 백악기(1억 년 전 ~ 6600만 년 전)에 살았으며 북아메리카에서 발견된 초식공룡입니다. 강력한 코뿔과 화려한 프릴에 6개의 뿔을 가지고 있는 각룡류 공룡입니다. 다른 각룡류와 다르게 눈 위에 뾰족한 뿔이 없으며 커다란 프릴 창은 스티라코사우루스 공룡의 특징입니다. 커다란 코뿔 때문에 ‘긴 가시가 있는 도마뱀’이란 스티라코사우루스 이름을 가지게 되었습니다.',
        photo : styraco
    },
    {
        name : '알베르토사우루스',
        content : '알베르토사우루스는 후기 백악기(1억만 년 전 ~ 6600만 년 전)에 살았으며 캐나다에서 발견된 육식공룡입니다. 알베르토사우루스의 이름은 캐나다 앨버타주에서 발견되었다는 의미입니다. 티라노사우루스와 거의 유사한 형태이지만 조금 작은 몸집을 가지고 있으며 좀 더 긴 앞발과 납작한 머리를 가지고 있습니다. 알베르토사우루스의 가장 큰 무기는 날카로운 이빨과 강력한 턱으로 굵은 목을 이용하며 어떠한 사냥감도 한번 물면 놓지 않았으며 뼈까지 부러트릴 정도의 강력한 무는 힘을 이용하여 사냥하였습니다. ',
        photo : albert
    },
    {
        name : '트루돈',
