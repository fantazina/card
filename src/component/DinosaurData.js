export default [
    ...
    {
        name : '트루돈',
        content : '트루돈은 후기 백악기(7700만 년 전 ~ 6900만 년 전)에 살았으며 미국의 몬태나주, 와이오밍주, 알래스카지역과 캐나다지역에서 발견된 육식공룡입니다. 수각류인 트루돈은 ‘상처 난 이빨’이라는 의미를 가지고 있는데 발견된 화석을 통하여 이빨이 크게 구부러져 있으며 뒷면에는 톱니날이 있었습니다. 가장 특별한 점은 모든 공룡 중에서 몸 크기에 비해 가장 큰 뇌를 가지고 있었습니다.',
        photo : ''
    },
    {
        name : '파라사우롤로푸스',
